                        ...
                        <div class="logo-search-category-wrapper">
                            ...
                            <div class="category-search-wrapper">
                                ...
                                <form method="GET" action="<?php echo site_url('/'); ?>" class="search-header">
                                    <input type="text" name="s" id="search" placeholder="Search for products, categories" required="">
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="category-btn category-hover-header menu-category">
                        <ul class="category-sub-menu" id="category-active-menu">
                            ...
                            <li>
                                <a href="Product-list.html" class="menu-item">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/03.svg"
                                        alt="icons">
                            ...
                            <li>
                                <a href="Product-list.html" class="menu-item">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/04.svg"
                                        alt="icons">
                            ...
                            <li>
                                <a href="Product-list.html" class="menu-item">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/05.svg"
                                        alt="icons">
                            ...
                            <li>
                                <a href="Product-list.html" class="menu-item">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/06.svg"
                                        alt="icons">
                                    <span>Breads &amp; Bakery</span>
                                </a>
                            </li>
                            <li>
                                <a href="Product-list.html" class="menu-item">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/07.svg"
                                        alt="icons">
                            ...
                            <li>
                                <a href="Product-list.html" class="menu-item">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/08.svg"
                                        alt="icons">
                            ...
                            <li>
                                <a href="Product-list.html" class="menu-item">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/09.svg"
                                        alt="icons">
                            ...
                            <li>
                                <a href="Product-list.html" class="menu-item">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/10.svg"
                                        alt="icons">
