                        ...
                        <nav class="nav-main mainmenu-nav mt--30">
                            <ul class="mainmenu metismenu" id="mobile-menu-active">
                                ...
                                <li class="has-droupdown">
                                    ...
                                    <ul class="submenu mm-collapse">
                                        <li><a class="mobile-menu-link" href="about.html">Who we are</a></li>
                                        <li><a class="mobile-menu-link" href="faq.html">Why organic</a></li>
                                        <li><a class="mobile-menu-link" href="invoice.html">How we worke</a></li>
                                    </ul>
                                </li>
                                <li class="has-droupdown">
                                    <a href="#" class="main">Shop</a>
                                    <ul class="submenu mm-collapse">
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/herbs.jpg" alt=""> All Products</a></li>
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/rice.jpg" alt="">Organic Rice</a></li>
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/ghee.jpg" alt="">Organic Ghee</a></li>
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/fruits.jpg" alt="">Organic Fruits</a></li>
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/herbs.jpg" alt="">Organic Herbs</a></li>
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/rice.jpg" alt="">Organic Rice</a></li>
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/ghee.jpg" alt="">Organic Ghee</a></li>
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/fruits.jpg" alt="">Organic Fruits</a></li>
                                     <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/herbs.jpg" alt="">Organic Herbs</a></li>
